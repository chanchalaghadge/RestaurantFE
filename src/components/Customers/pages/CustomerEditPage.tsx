...
function CustomerEditPage() {
  ...
  useEffect(() => {
    if (id) {
      customersApi.get(Number(id))
        .then(setCustomer)
        .catch((e: unknown) => setError(e instanceof Error ? e.message : "Unable to load customer."));
    }
  }, [id]);
  ...
  return (
    <section className="customers-page">
      <Breadcrumb items={[{ label: 'Home', path: '/dashboard' }, { label: 'Customers', path: '/customers' }, { label: `Edit ${customer.fullName}` }]} />
